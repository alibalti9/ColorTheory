...
<style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:'Inter',sans-serif;background:radial-gradient(circle at top left,${c3}36,transparent 30%),linear-gradient(180deg,${c1},#0e1016);color:${t1};display:flex;min-height:100vh}
aside{width:248px;background:rgba(7,10,14,.62);border-right:1px solid rgba(255,255,255,.08);padding:24px 14px;display:flex;flex-direction:column;gap:4px;backdrop-filter:blur(20px);flex-shrink:0}.sb-logo{display:flex;align-items:center;justify-content:space-between;font-size:16px;font-weight:800;padding:6px 10px 20px;letter-spacing:-.4px}.sb-chip{padding:5px 9px;border-radius:999px;background:${c2}22;border:1px solid ${c2}40;color:${c2};font-size:10px;font-weight:700}.sb-sec{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:1.4px;opacity:.34;padding:14px 10px 6px}.sb-item{display:flex;align-items:center;gap:10px;padding:11px 12px;border-radius:14px;cursor:pointer;font-size:13px;font-weight:600;opacity:.62;transition:all .18s;user-select:none}.sb-item:hover{background:rgba(255,255,255,.08);opacity:.92;transform:translateX(2px)}.sb-item.active{background:linear-gradient(135deg,${c2},${c3});color:${t2};opacity:1;box-shadow:0 10px 28px rgba(0,0,0,.22)}.sb-dot{width:8px;height:8px;border-radius:50%;flex-shrink:0;background:currentColor}.sb-note{margin-top:auto;padding:14px;border-radius:18px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08)}.sb-note b{display:block;font-size:12px;margin-bottom:6px}.sb-note p{font-size:11px;line-height:1.55;opacity:.62;margin-bottom:12px}.sb-note button{width:100%;padding:10px 12px;border:none;border-radius:12px;background:${c2};color:${t2};font:700 12px Inter,sans-serif;cursor:pointer}
main{flex:1;padding:28px;overflow-y:auto;min-width:0}.hero,.row{display:grid;grid-template-columns:1.2fr .8fr;gap:16px;margin-bottom:18px}.hero-card,.spotlight,.kpi,.ch-card,.tbl-card,.team-card{background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.09);border-radius:24px;backdrop-filter:blur(18px);box-shadow:0 16px 40px rgba(0,0,0,.18)}.hero-card{padding:26px;position:relative;overflow:hidden}.hero-card::after{content:'';position:absolute;inset:auto -10% -18% auto;width:220px;height:220px;border-radius:50%;background:${c2}20;filter:blur(16px)}.eyebrow{display:inline-flex;align-items:center;gap:8px;padding:7px 12px;border-radius:999px;background:rgba(255,255,255,.08);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase;color:${c2};margin-bottom:16px}.hero h1{font-size:clamp(30px,4vw,44px);font-weight:800;line-height:1.02;letter-spacing:-1.8px;max-width:10ch;margin-bottom:12px}.hero p{font-size:13px;line-height:1.7;opacity:.68;max-width:54ch}.hero-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:20px}.add-btn,.ghost-btn{padding:11px 16px;border:none;border-radius:14px;font:700 12px Inter,sans-serif;cursor:pointer;transition:transform .18s}.add-btn{background:${c2};color:${t2}}.ghost-btn{background:rgba(255,255,255,.07);color:${t1};border:1px solid rgba(255,255,255,.1)}.add-btn:hover,.ghost-btn:hover{transform:translateY(-2px)}.mini-stats{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;margin-top:18px}.mini-stat{padding:12px;border-radius:18px;background:rgba(7,10,14,.22);border:1px solid rgba(255,255,255,.08)}.mini-stat span{display:block;font-size:10px;opacity:.46;text-transform:uppercase;letter-spacing:.8px;margin-bottom:5px}.mini-stat b{font-size:16px}
.spotlight{padding:22px}.spot-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:12px}.spot-head b{font-size:15px}.spot-chart{display:flex;align-items:flex-end;gap:8px;height:150px;padding-top:6px}.spot-bar{flex:1;border-radius:12px 12px 6px 6px;position:relative;opacity:.78;cursor:pointer}.spot-bar.active{opacity:1;box-shadow:0 10px 20px rgba(0,0,0,.18)}.spot-bar i{position:absolute;bottom:-22px;left:50%;transform:translateX(-50%);font-style:normal;font-size:9px;opacity:.45}.spot-bar b{position:absolute;bottom:calc(100% + 8px);left:50%;transform:translateX(-50%);padding:4px 8px;border-radius:999px;background:#0c0d11;color:#fff;font-size:10px;display:none}.spot-bar:hover b{display:block}
.kpi-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:14px;margin-bottom:18px}.kpi{padding:18px}.kpi-lbl{font-size:10px;opacity:.42;font-weight:700;text-transform:uppercase;letter-spacing:.9px;margin-bottom:9px}.kpi-val{font-size:30px;font-weight:800;letter-spacing:-1px;margin-bottom:4px}.kpi-ch{font-size:11px;font-weight:700}.up{color:#34d399}.dn{color:#f87171}
.ch-card,.tbl-card,.team-card{padding:20px}.card-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:16px}.card-head b{font-size:14px}.card-head span{font-size:11px;opacity:.45}.sel{background:rgba(255,255,255,.06);color:${t1};border:1px solid rgba(255,255,255,.12);padding:8px 10px;border-radius:12px;font:600 11px Inter,sans-serif}.pie-list{display:flex;flex-direction:column;gap:12px}.pie-item{display:flex;align-items:center;gap:10px}.pie-dot{width:10px;height:10px;border-radius:999px;flex-shrink:0}.pie-item>div{flex:1}.pie-top{display:flex;justify-content:space-between;font-size:12px}.pie-top span:first-child{opacity:.68}.pie-bar{height:8px;border-radius:999px;margin-top:7px;box-shadow:inset 0 1px 0 rgba(255,255,255,.2)}
.pipeline{display:flex;flex-direction:column;gap:12px}.pipe{padding:14px;border-radius:18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07)}.pipe-top{display:flex;justify-content:space-between;font-size:12px;font-weight:600;margin-bottom:8px}.pipe-track{height:8px;border-radius:999px;background:rgba(255,255,255,.08);overflow:hidden}.pipe-fill{height:100%;border-radius:999px}
.tbl-title{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}.tbl-search{padding:9px 12px;border-radius:12px;border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:${t1};font:600 11px Inter,sans-serif;outline:none;min-width:160px}.tbl-search:focus{border-color:${c2}}table{width:100%;border-collapse:collapse}th{text-align:left;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.8px;opacity:.35;padding:0 12px 12px 0;cursor:pointer;user-select:none}td{padding:12px 12px 12px 0;font-size:12px;border-top:1px solid rgba(255,255,255,.06)}tr:hover td{background:rgba(255,255,255,.02)}.bdg{padding:4px 9px;border-radius:999px;font-size:10px;font-weight:700;display:inline-block}.bg{background:rgba(52,211,153,.15);color:#34d399}.by{background:rgba(251,191,36,.14);color:#fbbf24}.br{background:rgba(248,113,113,.14);color:#f87171}
.grid-two{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.project-card{padding:16px;border-radius:18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);cursor:pointer}.project-card h4{font-size:14px;margin-bottom:8px}.project-card p{font-size:11px;opacity:.58;line-height:1.55;margin-bottom:10px}.project-bar{height:8px;border-radius:999px;background:rgba(255,255,255,.08);overflow:hidden}.project-bar i{display:block;height:100%;border-radius:999px}.team-list{display:flex;flex-direction:column;gap:10px}.person{display:flex;align-items:center;gap:12px;padding:14px 16px;border-radius:18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.07);cursor:pointer}.av{width:38px;height:38px;border-radius:14px;display:flex;align-items:center;justify-content:center;font-weight:800}.person b{display:block;font-size:13px}.person span{font-size:11px;opacity:.5}
.page{display:none}.page.active{display:block}#toast-msg{position:fixed;bottom:22px;left:50%;transform:translateX(-50%);background:#111;color:#eee;padding:9px 16px;border-radius:12px;font-size:11px;font-weight:700;border:1px solid rgba(255,255,255,.12);opacity:0;transition:opacity .25s;pointer-events:none;z-index:9999}#toast-msg.show{opacity:1}
@media(max-width:960px){body{display:block}aside{display:none}main{padding:18px}.hero,.row{grid-template-columns:1fr}.grid-two{grid-template-columns:1fr}}
</style></head><body>
<aside><div class="sb-logo"><span>◈ Orbit Admin</span><span class="sb-chip">Live</span></div><div class="sb-sec">Workspace</div><div class="sb-item active" onclick="navTo(this,'page-overview')"><div class="sb-dot" style="background:${c2}"></div>Overview</div><div class="sb-item" onclick="navTo(this,'page-analytics')"><div class="sb-dot" style="background:${c3}"></div>Analytics</div><div class="sb-item" onclick="navTo(this,'page-projects')"><div class="sb-dot" style="background:${c4}"></div>Projects</div><div class="sb-item" onclick="navTo(this,'page-team')"><div class="sb-dot"></div>Team</div><div class="sb-sec">Support</div><div class="sb-item" onclick="showT('Automation rules coming soon')"><div class="sb-dot"></div>Automation</div><div class="sb-item" onclick="showT('Help center opening')"><div class="sb-dot"></div>Help Center</div><div class="sb-note"><b>Growth pulse</b><p>Pipeline velocity is up 14% this week with stronger expansion revenue.</p><button onclick="showT('Weekly digest sent')">Send digest</button></div></aside>
<main>
<div id="page-overview" class="page active"><section class="hero"><div class="hero-card"><div class="eyebrow">Performance cockpit</div><h1>Revenue stays healthy across every channel.</h1><p>Your palette now drives the shell, cards, and highlights so the dashboard feels premium without losing clarity.</p><div class="hero-actions"><button class="add-btn" onclick="showT('New report created')">Create report</button><button class="ghost-btn" onclick="showT('Board shared with the team')">Share board</button></div><div class="mini-stats"><div class="mini-stat"><span>MRR</span><b>$48.2K</b></div><div class="mini-stat"><span>Win rate</span><b>38%</b></div><div class="mini-stat"><span>Teams</span><b>24</b></div></div></div><div class="spotlight"><div class="spot-head"><b>Monthly revenue</b><span>2025</span></div><div class="spot-chart">${bars.map((v,i)=>`<div class="spot-bar${i===11?' active':''}" style="height:${v}%;background:linear-gradient(180deg,${p[i%p.length]},rgba(255,255,255,.18))"><b>$${(v*0.58).toFixed(1)}K</b><i>${months[i]}</i></div>`).join('')}</div></div></section><div class="kpi-grid"><div class="kpi"><div class="kpi-lbl">Revenue</div><div class="kpi-val" style="color:${c2}">$48.2K</div><div class="kpi-ch up">↑ 12.4% vs last month</div></div><div class="kpi"><div class="kpi-lbl">Active users</div><div class="kpi-val">3,842</div><div class="kpi-ch up">↑ 8.1% this week</div></div><div class="kpi"><div class="kpi-lbl">Churn rate</div><div class="kpi-val">2.3%</div><div class="kpi-ch dn">↑ 0.4% vs last period</div></div><div class="kpi"><div class="kpi-lbl">NPS score</div><div class="kpi-val">74</div><div class="kpi-ch up">↑ 3 pts this quarter</div></div></div><div class="row"><div class="ch-card"><div class="card-head"><div><b>Traffic sources</b><span>Where the best sessions begin</span></div><select class="sel" onchange="showT('Traffic view updated')"><option>Last 30 days</option><option>Last 90 days</option></select></div><div class="pie-list">${p.slice(0,5).map((c,i)=>{const lb=['Organic','Direct','Referral','Social','Email'];const pc=[38,25,18,12,7];return `<div class="pie-item"><div class="pie-dot" style="background:${c}"></div><div><div class="pie-top"><span>${lb[i]}</span><span>${pc[i]}%</span></div><div class="pie-bar" style="width:${pc[i]*2.6}%;background:${c}"></div></div></div>`;}).join('')}</div></div><div class="ch-card"><div class="card-head"><div><b>Pipeline health</b><span>Weighted opportunity mix</span></div><span>Q4</span></div><div class="pipeline">${[['Enterprise',78,c2],['Mid-market',52,c3],['Self-serve',31,c4]].map((item)=>`<div class="pipe"><div class="pipe-top"><span>${item[0]}</span><span>${item[1]}%</span></div><div class="pipe-track"><div class="pipe-fill" style="width:${item[1]}%;background:${item[2]}"></div></div></div>`).join('')}</div></div></div><div class="tbl-card"><div class="tbl-title"><div><b>Recent transactions</b><span style="display:block;font-size:11px;opacity:.45;margin-top:4px">Search by client, status, or date</span></div><input class="tbl-search" id="tbl-q" placeholder="Search..." oninput="filterTbl(this.value)"></div><table><thead><tr><th onclick="showT('Sorted by client')">Client</th><th onclick="showT('Sorted by amount')">Amount</th><th>Date</th><th>Status</th><th></th></tr></thead><tbody id="tbl-body"><tr><td>Acme Corp</td><td style="font-family:monospace">$4,200</td><td>Today, 09:41</td><td><span class="bdg bg">Paid</span></td><td><button onclick="showT('Invoice downloaded')" style="background:transparent;border:none;color:inherit;opacity:.6;cursor:pointer;font-size:11px">Open</button></td></tr><tr><td>Stark Industries</td><td style="font-family:monospace">$12,500</td><td>Yesterday</td><td><span class="bdg by">Pending</span></td><td><button onclick="showT('Reminder sent')" style="background:transparent;border:none;color:inherit;opacity:.6;cursor:pointer;font-size:11px">Ping</button></td></tr><tr><td>Wayne Enterprises</td><td style="font-family:monospace">$8,750</td><td>Dec 18</td><td><span class="bdg bg">Paid</span></td><td><button onclick="showT('Invoice downloaded')" style="background:transparent;border:none;color:inherit;opacity:.6;cursor:pointer;font-size:11px">Open</button></td></tr><tr><td>Umbrella Co.</td><td style="font-family:monospace">$2,100</td><td>Dec 17</td><td><span class="bdg br">Failed</span></td><td><button onclick="showT('Retry initiated')" style="background:transparent;border:none;color:inherit;opacity:.6;cursor:pointer;font-size:11px">Retry</button></td></tr><tr><td>Globex Corp</td><td style="font-family:monospace">$6,300</td><td>Dec 15</td><td><span class="bdg bg">Paid</span></td><td><button onclick="showT('Invoice downloaded')" style="background:transparent;border:none;color:inherit;opacity:.6;cursor:pointer;font-size:11px">Open</button></td></tr></tbody></table></div></div>
<div id="page-analytics" class="page"><div class="kpi-grid"><div class="kpi"><div class="kpi-lbl">Page views</div><div class="kpi-val" style="color:${c2}">182K</div><div class="kpi-ch up">↑ 22% this month</div></div><div class="kpi"><div class="kpi-lbl">Sessions</div><div class="kpi-val">41.2K</div><div class="kpi-ch up">↑ 15%</div></div><div class="kpi"><div class="kpi-lbl">Bounce rate</div><div class="kpi-val">38%</div><div class="kpi-ch dn">↑ 2%</div></div><div class="kpi"><div class="kpi-lbl">Conversion</div><div class="kpi-val">6.8%</div><div class="kpi-ch up">↑ 1.1%</div></div></div></div>
<div id="page-projects" class="page"><div class="card-head" style="margin-bottom:16px"><div><b style="font-size:18px">Active projects</b><span style="display:block;margin-top:4px">Design systems, product surfaces, and platform workstreams</span></div><button class="add-btn" onclick="showT('New project created')">New project</button></div><div class="grid-two">${['Design System','Web App','Mobile SDK','API v3'].map((n,i)=>`<div class="project-card" onclick="showT('Opened: ${n}')"><h4>${n}</h4><p>${['Building the new token architecture and primitives.','Refreshing the onboarding funnel and workspace shell.','Shipping new palette-powered native components.','Stabilizing release tooling and partner endpoints.'][i]}</p><div class="project-bar"><i style="width:${[72,45,88,31][i]}%;background:${p[i%p.length]}"></i></div><div style="margin-top:10px;font-size:11px;opacity:.55">${[72,45,88,31][i]}% complete</div></div>`).join('')}</div></div>
<div id="page-team" class="page"><div class="card-head" style="margin-bottom:16px"><div><b style="font-size:18px">Team directory</b><span style="display:block;margin-top:4px">Operators, builders, and design partners</span></div><button class="add-btn" onclick="showT('Invite sent')">Invite member</button></div><div class="team-card"><div class="team-list">${['Alex Kim','Sam Rivera','Jordan Lee','Taylor Chen'].map((n,i)=>`<div class="person" onclick="showT('Viewing ${n}')"><div class="av" style="background:${p[i%p.length]};color:${textOn(p[i%p.length])}">${n[0]}</div><div style="flex:1"><b>${n}</b><span>${['Designer','Engineer','Product','Engineer'][i]}</span></div><span class="bdg bg">Active</span></div>`).join('')}</div></div></div>
</main><div id="toast-msg"></div><script>function showT(msg){const t=document.getElementById('toast-msg');t.textContent=msg;t.classList.add('show');clearTimeout(t._t);t._t=setTimeout(()=>t.classList.remove('show'),2000)}function navTo(el,pid){document.querySelectorAll('.sb-item').forEach(function(i){i.classList.remove('active')});el.classList.add('active');document.querySelectorAll('.page').forEach(function(pg){pg.style.display='none';pg.classList.remove('active')});const page=document.getElementById(pid);if(page){page.style.display='block';page.classList.add('active')}}function filterTbl(q){document.querySelectorAll('#tbl-body tr').forEach(function(r){r.style.display=r.textContent.toLowerCase().includes(q.toLowerCase())?'':'none'})}</script></body></html>`;
}
...
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
<style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:'Inter',sans-serif;background:radial-gradient(circle at top right,${c2}26,transparent 28%),linear-gradient(180deg,${c1},#0b0c12);color:${t1}}
.nav{display:flex;align-items:center;justify-content:space-between;padding:18px 48px;position:sticky;top:0;z-index:10;backdrop-filter:blur(16px);background:rgba(11,12,18,.62);border-bottom:1px solid rgba(255,255,255,.06)}.logo{font-weight:800;font-size:16px;letter-spacing:-.3px}.links{display:flex;gap:22px}.links a{text-decoration:none;color:${t1};opacity:.58;font-size:13px;font-weight:600;transition:all .15s}.links a:hover{opacity:1}.links a.active{opacity:1;color:${c2}}
.hero{padding:78px 48px 56px;max-width:1180px;margin:0 auto;display:grid;grid-template-columns:1.15fr .85fr;gap:26px;align-items:center}.eyebrow{display:inline-flex;padding:7px 12px;border-radius:999px;background:${c2}20;border:1px solid ${c2}40;color:${c2};font-size:10px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin-bottom:18px}.hero-copy h1{font-size:clamp(42px,6vw,78px);font-weight:800;line-height:1;letter-spacing:-2.8px;margin-bottom:18px}.hero-copy h1 em{font-style:normal;background:linear-gradient(135deg,${c2},${c3});-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}.sub{font-size:16px;opacity:.7;line-height:1.8;max-width:52ch;margin-bottom:26px}.acts{display:flex;gap:12px;flex-wrap:wrap}.btn-m,.btn-o,.btn-s{padding:13px 24px;border-radius:14px;font:700 13px Inter,sans-serif;cursor:pointer;transition:transform .18s}.btn-m{background:${c2};color:${t2};border:none}.btn-o{background:rgba(255,255,255,.06);color:${t1};border:1px solid rgba(255,255,255,.12)}.btn-s{background:transparent;color:${t1};border:1px dashed rgba(255,255,255,.18)}.btn-m:hover,.btn-o:hover,.btn-s:hover{transform:translateY(-2px)}
.hero-card{padding:24px;border-radius:28px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08);backdrop-filter:blur(20px);box-shadow:0 18px 40px rgba(0,0,0,.18);position:relative;overflow:hidden}.hero-card::after{content:'';position:absolute;inset:auto -12% -14% auto;width:220px;height:220px;border-radius:50%;background:${c3}18;filter:blur(10px)}.profile{display:flex;align-items:center;gap:14px;margin-bottom:18px}.avatar{width:62px;height:62px;border-radius:20px;background:linear-gradient(135deg,${c2},${c3});display:flex;align-items:center;justify-content:center;color:${t2};font-size:24px;font-weight:800}.meta b{display:block;font-size:18px}.meta span{display:block;font-size:12px;opacity:.55;margin-top:3px}.hero-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin:18px 0}.mini{padding:14px;border-radius:18px;background:rgba(0,0,0,.16);border:1px solid rgba(255,255,255,.08)}.mini span{display:block;font-size:10px;text-transform:uppercase;letter-spacing:.8px;opacity:.48;margin-bottom:6px}.mini b{font-size:18px}.quote{padding:16px;border-radius:18px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);font-size:13px;line-height:1.7;opacity:.76}
.section{padding:22px 48px 58px;max-width:1180px;margin:0 auto}.sec-lbl{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:2px;opacity:.38;margin-bottom:18px}.w-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:16px}.w-card{border-radius:24px;overflow:hidden;cursor:pointer;transition:transform .2s,box-shadow .2s}.w-card:hover{transform:translateY(-6px);box-shadow:0 18px 40px rgba(0,0,0,.24)}.w-img{height:220px;display:flex;align-items:flex-end;justify-content:space-between;padding:18px;color:#fff;font-size:34px}.w-pill{padding:7px 10px;border-radius:999px;background:rgba(255,255,255,.16);border:1px solid rgba(255,255,255,.18);font-size:10px;font-weight:700;letter-spacing:.8px;text-transform:uppercase}.w-meta{padding:18px;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.08);border-top:none}.w-meta h3{font-size:16px;font-weight:700;margin-bottom:6px}.w-meta p{font-size:12px;opacity:.56;line-height:1.65}.w-meta span{display:inline-block;margin-top:10px;font-size:11px;font-weight:700;color:${c2}}
.skills-sec{padding:0 48px 58px}.skill-shell{max-width:1180px;margin:0 auto;padding:24px;border-radius:28px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08)}.chips{display:flex;gap:10px;flex-wrap:wrap}.chip{padding:8px 15px;border-radius:999px;font-size:12px;font-weight:700;border:1px solid;cursor:pointer;transition:transform .15s}.chip:hover{transform:translateY(-2px)}
.contact{padding:0 48px 64px}.contact-shell{max-width:1180px;margin:0 auto;display:grid;grid-template-columns:.85fr 1.15fr;gap:18px}.contact-copy,.contact-card{padding:24px;border-radius:28px;background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08)}.contact-copy h2{font-size:34px;font-weight:800;letter-spacing:-1px;margin-bottom:10px}.contact-copy p{font-size:14px;opacity:.65;line-height:1.7;margin-bottom:18px}.contact-list{display:flex;flex-direction:column;gap:10px}.contact-item{padding:12px 14px;border-radius:16px;background:rgba(0,0,0,.14);font-size:12px}.form-row{margin-bottom:14px}label{display:block;font-size:11px;font-weight:600;opacity:.52;text-transform:uppercase;letter-spacing:.8px;margin-bottom:6px}.inp{width:100%;padding:12px 14px;border-radius:16px;border:1px solid rgba(255,255,255,.12);background:rgba(255,255,255,.05);color:${t1};font-size:13px;font-family:inherit;outline:none;transition:border-color .15s}.inp:focus{border-color:${c2}}textarea.inp{height:110px;resize:vertical}.send-btn{width:100%;padding:13px;background:${c2};color:${t2};border:none;border-radius:16px;font-weight:800;font-size:14px;font-family:inherit;cursor:pointer}
footer{padding:26px 48px 36px;display:flex;justify-content:space-between;opacity:.36;font-size:11px;flex-wrap:wrap;gap:8px}.modal-bg{display:none;position:fixed;inset:0;background:rgba(0,0,0,.68);backdrop-filter:blur(10px);z-index:200;align-items:center;justify-content:center}.modal-bg.open{display:flex}.modal{background:#14151c;border:1px solid rgba(255,255,255,.1);border-radius:24px;padding:28px;max-width:420px;width:90%;position:relative;box-shadow:0 24px 48px rgba(0,0,0,.32)}.modal h3{font-size:18px;font-weight:800;margin-bottom:8px}.modal p{font-size:13px;opacity:.62;line-height:1.65;margin-bottom:20px}.modal-close{position:absolute;top:14px;right:14px;background:transparent;border:none;color:inherit;opacity:.5;font-size:18px;cursor:pointer;line-height:1}.modal-btns{display:flex;gap:10px;justify-content:flex-end}.mbtn{padding:10px 18px;border-radius:14px;font-weight:700;font-size:13px;font-family:inherit;cursor:pointer}.mbtn-p{background:${c2};color:${t2};border:none}.mbtn-s{background:transparent;color:${t1};border:1px solid rgba(255,255,255,.15)}#toast-msg{position:fixed;bottom:22px;left:50%;transform:translateX(-50%);background:#111;color:#eee;padding:8px 16px;border-radius:12px;font-size:11px;font-weight:700;border:1px solid rgba(255,255,255,.12);opacity:0;transition:opacity .25s;pointer-events:none;z-index:9999}#toast-msg.show{opacity:1}
@media(max-width:860px){.hero,.contact-shell{grid-template-columns:1fr}.nav,.hero,.section,.skills-sec,.contact,footer{padding-left:18px;padding-right:18px}}@media(max-width:640px){.links{display:none}.hero{padding-top:52px}.hero-copy h1{font-size:clamp(40px,14vw,56px)}}
</style></head><body>
...
<section class="hero"><div class="hero-copy"><div class="eyebrow">Creative developer</div><h1>I craft <em>beautiful</em> digital experiences.</h1><p class="sub">Full-stack designer and developer building product stories, motion systems, and interfaces with a sharp editorial feel.</p><div class="acts"><button class="btn-m" onclick="document.getElementById('work').scrollIntoView({behavior:'smooth'})">View my work</button><button class="btn-o" onclick="openModal()">Download CV</button><button class="btn-s" onclick="document.getElementById('contact').scrollIntoView({behavior:'smooth'})">Start a project</button></div></div><div class="hero-card"><div class="profile"><div class="avatar">A</div><div class="meta"><b>Alex Morgan</b><span>Design engineer · product systems</span></div></div><div class="hero-grid"><div class="mini"><span>Experience</span><b>8 years</b></div><div class="mini"><span>Projects shipped</span><b>36</b></div><div class="mini"><span>Response time</span><b>24h</b></div><div class="mini"><span>Current focus</span><b>Motion UI</b></div></div><div class="quote">"I blend interface design with frontend craft so the product feels cohesive from concept to code."</div></div></section>
...
<footer><span>© 2025 Alex Design</span><span>Crafted with ChromaStudio previews</span></footer>
...
function setActive(el){document.querySelectorAll('.links a').forEach(function(a){a.classList.remove('active')});el.classList.add('active');const id=el.getAttribute('href').slice(1);document.getElementById(id).scrollIntoView({behavior:'smooth'})}
function openModal(){document.getElementById('modal').classList.add('open')}
function closeModal(){document.getElementById('modal').classList.remove('open')}
function submitForm(){const n=document.getElementById('f-name').value,e=document.getElementById('f-email').value,m=document.getElementById('f-msg').value;if(!n||!e||!m){showT('Please fill all fields');return}showT('Message sent - I will reply within 24h');document.getElementById('f-name').value='';document.getElementById('f-email').value='';document.getElementById('f-msg').value=''}
